...
export const config = {
  ...
  emailAuthClientId: process.env.EMAIL_AUTH_CLIENT_ID ?? '',
  emailAuthClientSecret: process.env.EMAIL_AUTH_CLIENT_SECRET ?? '',
  emailAuthRefreshToken: process.env.EMAIL_AUTH_REFRESH_TOKEN ?? '',
